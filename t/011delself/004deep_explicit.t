...
my $pid = _GDT->test_spawn_daemon(File::Spec->catfile($FindBin::Bin, '004gdnsd.conf'));
...
_GDT->test_dns(
    qname => 'foo.subz.example.com', qtype => 'A',
    header => { aa => 0 },
    auth => 'subz.example.com 86400 NS ns1.subz.example.com',
    addtl => 'ns1.subz.example.com 86400 A 192.0.2.100',
);
...
_GDT->test_dns(
    qname => 'baz.deeper.subz.example.com', qtype => 'MX',
    answer => 'baz.deeper.subz.example.com 86400 MX 0 www.subz.example.com',
    auth => 'deeper.subz.example.com 86400 NS ns1.deeper.subz.example.com',
    addtl => 'ns1.deeper.subz.example.com 86400 A 192.0.2.3',
);

_GDT->test_dns(
    qname => 'quux.deeper.subz.example.com', qtype => 'A',
    answer => 'quux.deeper.subz.example.com 86400 CNAME www.subz.example.com',
);
