...
_GDT->test_dns(
    ...
    answer => 'up.example.com 25 A 127.0.0.1',
);

_GDT->test_dns(
    qname => 'down2.example.com', qtype => 'A',
    answer => 'down2.example.com 40 A 127.0.0.1',
);

_GDT->test_dns(
    qname => 'timeout.example.com', qtype => 'A',
    answer => 'timeout.example.com 40 A 127.0.0.1',
);

_GDT->test_dns(
    qname => 'down.example.com', qtype => 'A',
    answer => 'down.example.com 40 A 127.0.0.1',
);

_GDT->test_dns(
    qname => 'down-100-5.example.com', qtype => 'A',
    answer => 'down-100-5.example.com 40 A 127.0.0.1',
);

_GDT->test_dns(
    qname => 'up-100-5.example.com', qtype => 'A',
    answer => 'up-100-5.example.com 20 A 127.0.0.1',
);

_GDT->test_dns(
    qname => 'up-100.example.com', qtype => 'A',
    answer => 'up-100.example.com 50 A 127.0.0.1',
);
