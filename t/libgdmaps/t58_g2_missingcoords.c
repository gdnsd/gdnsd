...
int main(int argc V_UNUSED, char* argv[] V_UNUSED)
{
    ...
    gdmaps_test_lookup_check(gdmaps, "my_prod_map", "69.58.186.119", "\1\2\5\3", 17); // US East Coast
    gdmaps_test_lookup_check(gdmaps, "my_prod_map", "117.53.170.202", "\3\5\2\1", 23); // Australia
