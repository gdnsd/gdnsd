...
but with the same userid the daemon normal drops privileges to.
Standard input will be open on F</dev/null>, and standard output/error
will be pipes back to the main daemon for recording error output
on failure.
