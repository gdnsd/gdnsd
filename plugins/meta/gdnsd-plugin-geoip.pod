...
=item C<city_region_names = /path/to/fips_include>
...
=item C<geoip_db = /path/to/GeoIP.dat>
...
=item C<geoip_db_v4_overlay = /path/to/GeoIP.dat>
...
=item C<datacenters = [ one, two, three, ... ]>
