...
int main(int argc V_UNUSED, char* argv[] V_UNUSED) {
    ...
    gdmaps_test_lookup_check(gdmaps, "my_prod_map", "192.0.2.1", "\1\2", 0);
    gdmaps_test_lookup_check(gdmaps, "my_prod_map", "2600:3c02:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF", "\1\2", 6);
    exit(exit_status());
}
