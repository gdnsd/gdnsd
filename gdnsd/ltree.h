...
F_WUNUSED F_NONNULL
bool ltree_add_rec_a(const zone_t* zone, const uint8_t* dname, uint32_t addr, const unsigned ttl, const unsigned limit_v4, const bool ooz);
F_WUNUSED F_NONNULL
...
F_WUNUSED F_NONNULL
bool ltree_add_rec_naptr(const zone_t* zone, const uint8_t* dname, const uint8_t* rhs, const unsigned ttl, const unsigned order, const unsigned pref, const unsigned num_texts, uint8_t** texts);
F_WUNUSED F_NONNULL
