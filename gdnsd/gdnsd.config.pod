...
The following two parameters tweak the timing behavior of
the auto mode.
...
=item B<zones_rfc1035_auto_quiesce>

Integer seconds, default 5, min 3, max 60.  Only applies when
C<zones_rfc1035_auto> is C<true>.

When a change is detected in automatic mode, this value is used
