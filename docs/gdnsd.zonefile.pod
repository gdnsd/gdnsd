...
There is also experimental support for djbdns-format zonefiles,
documented separately in L<gdnsd.djbzones(5)>.
...
L<gdnsd(8)>, L<gdnsd.config(5)>, L<gdnsd.djbzones(5)>
