...
configuration and/or data files  The directory for these files is commonly
e.g. F</etc/gdnsd/geoip/> given autoconf $sysconfdir of F</etc>.
If any of the pathnames are specified as absolute paths, they will be taken
literally.
