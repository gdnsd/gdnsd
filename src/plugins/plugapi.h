...
typedef void (*gdnsd_add_mon_addr_cb_t)(const char* desc, const char* svc_name, const char* cname, const struct anysin* addr, const unsigned idx);
...
struct plugin* gdnsd_plugin_find(const char* plugin_name);
